          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10} mb={10}>
            <Stack spacing={7}>
              ...
              >
                ...
                education and project-based learning opportunities, as well as
                to drive innovation in the indexing space through the testing of
                R&D efforts from core developers.
              </Text>
              ...
              >
                ...
                Graph and the broader web3 ecosystem, and to be recognized as
                the foremost organization for Indexers. With a focus on
                community building and collaboration, we aim to provide a
                supportive and empowering environment for indexers to develop
                their skills and bring new ideas to the table.
              </Text>
              ...
              >
                ...
                <Feature
                  icon={
                    <Icon as={AiFillBulb} color={'yellow.500'} w={7} h={7} />
                  }
